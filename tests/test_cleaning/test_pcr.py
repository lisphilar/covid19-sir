...
class TestPCRData(object):
    ...
    def test_subset(self, pcr_data, country):
        ...
        assert set([Term.DATE, Term.TESTS, Term.C, PCRData.TESTS_DIFF]).issubset(df.columns)
    ...
    def test_positive_rate(self, pcr_data, country, last_date):
        ...
        assert set([PCRData.TESTS_DIFF, PCRData.C_DIFF, PCRData.PCR_RATE]).issubset(df.columns)
